...
* **מספר שחקנים**: שחקן יחיד (Single Player), עם אפשרות להשוואת ציונים עם שחקנים אחרים (leaderboard)

* **דפוסי אינטראקציה**: אין אינטראקציה ישירה בין שחקנים, אבל יש אפשרות לשתף עולמות ולהשוות "כמה זמן המערכת נשארה מאוזנת"

![Target Audience](https://placeholder-for-screenshot.com/ecolink-audience.png)

### 2. יעדים

**יעדי המשחק:**
* יעד מרכזי: לשמור על המערכת האקולוגית מאוזנת למשך X ימים (משתנה לפי שלב)
* יעדי משנה: להגיע לאוכלוסייה יציבה של כל מין, להימנע מהכחדות, לעבור אירועים אקראיים (בצורת, גשם זלזלי)
* יעד ארוך טווח: לפתוח biomes חדשים (מדבר, יער, טונדרה) ומינים נוספים
* יעד תחרותי: להגיע לשיא זמן איזון ארוך ביותר (תחרות עם שחקנים אחרים)

**הודעת יעדים לשחקן:**
* בתחילת כל שלב תופיע הודעה: "שמור על המערכת יציבה ל-30 ימים"
...
![Goals Display](https://placeholder-for-screenshot.com/ecolink-goals.png)
...
השחקן מצליח לשמור על האיזון למשך X ימים (המטרה). מסך "SUCCESS!" עם סטטיסטיקות: אוכלוסיות ממוצעות, מספר מינים ששרדו, דירוג איזון. פותח שלב הבא או biome חדש. אופציה: "המשך במצב חופשי" (sandbox) עם העולם שיצר. ניקוד מבוסס על: זמן איזון, מגוון מינים, התמודדות עם אירועים. אפשרות לשתף את העולם עם חברים או leaderboard.
...
![Process Flow](https://placeholder-for-screenshot.com/ecolink-process.png)

### 4. חוקים

**חוקים מגבילים:**
* השחקן יכול להוסיף אלמנטים רק כשיש לו "נקודות אנרגיה" (משאב מוגבל)
* לא ניתן למקם אלמנטים על משבצות לא מתאימות (דג במדבר = לא עובד)
...
![Rules Illustration](https://placeholder-for-screenshot.com/ecolink-rules.png)
...
![Resources UI](https://placeholder-for-screenshot.com/ecolink-resources.png)
...
**עימות בין שחקנים:**
* אין עימות ישיר
* תחרות עקיפה: Leaderboard של "העולם המאוזן הכי הרבה זמן"
* אופציונלי: "אתגר שבועי" שבו כל השחקנים מנסים לאזן את אותו העולם
...
![Conflicts](https://placeholder-for-screenshot.com/ecolink-conflicts.png)
...
![Map Design](https://placeholder-for-screenshot.com/ecolink-map.png)
...
![Results Screen](https://placeholder-for-screenshot.com/ecolink-results.png)
...
* **מבנה שלבים**: EcoLink יהיה level-based עם יעדים ברורים, לא sandbox חופשי בלבד
